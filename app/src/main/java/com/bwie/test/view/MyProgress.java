...
public class MyProgress extends View {
    ...
    // 设置外圆颜色
    private int backCirclePaintColor;
    //圆半径
...
//        backCirclePaintColor = array.getColor(R.styleable.CustomCircleProgress_progress_default_color, Color.LTGRAY);
//        //默认圆的高度
//        circleBorderWidth = (int) array.getDimension(R.styleable.CustomCircleProgress_progress_default_height, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
//        //进度条的高度
//        circlePadding = (int) array.getDimension(R.styleable.CustomCircleProgress_progress_reached_height, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
//        //圆的半径
//        radius = (int) array.getDimension(R.styleable.CustomCircleProgress_circle_radius, (getMeasuredWidth() - circlePadding * 3) / 2);
//        //最后不要忘了回收 TypedArray
//        array.recycle();
...
//        backCirclePaint.setMaskFilter(new BlurMaskFilter(20, BlurMaskFilter.Blur.OUTER));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //半径
        radius= (getMeasuredWidth() - circlePadding * 3) / 2;
        //X轴中点坐标
        ...
        float textWidth2 = textPaint2.measureText("学习进度");

        int textHeight = (int) (Math.ceil(textPaint.getFontMetrics().descent - textPaint.getFontMetrics().ascent) + 2);
        canvas.drawText("学习进度" ,centerX - textWidth / 2 , centerX - textHeight ,textPaint2);
